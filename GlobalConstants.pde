...
final int SETTINGS_KNOB_RADIUS = 16;

enum Setting {
  GAIN, PITCH, PAN, START, BIT_DEPTH, BIT_RATE, FILTER_FREQ, FILTER_REZ, DELAY_TIME, DELAY_FEEDBACK 
}
...
enum StepType {
  STANDARD, RESTART, REPEAT_MEASURE, REPEAT_BEAT, REPEAT_STEP, RANDOM_MEASURE, 
}
